...
class Languages {
  strings: any = {
    ja: {
      ...
      'common.role_admin': 'Admin Vĩnh An',
      'common.role_member': 'Thành viên',
      'system.title.success': 'Thành công',
      'system.title.error': 'Lỗi',
      'system.title.request_sent': 'Gửi yêu cầu',
      'system.msg.error_general': 'Không thể thực hiện yêu cầu lúc này. Vui lòng thử lại sau.',
      ...
      'screen.home.logout_title': 'Xác nhận đăng xuất',
      'screen.home.logout_msg': 'Bạn có chắc chắn muốn đăng xuất khỏi ứng dụng Vĩnh An không?',
      ...
      'screen.family_tree.modal_select_title': 'Chọn thành viên',
      'screen.family_tree.search_placeholder': 'Tìm tên hoặc pháp danh...',
      'screen.family_tree.btn_create_new': 'Tạo tài khoản mới',
      'screen.family_tree.assign_success': 'Đã cập nhật vị trí thành viên thành công.',
      'screen.family_tree.assign_request_sent': 'Yêu cầu gán vị trí đã được gửi. Vui lòng đợi phê duyệt.',
      'screen.family_tree.modal_create_account_title': 'Tạo tài khoản thành viên',
      'screen.family_tree.label_email_acc': 'Email đăng nhập',
      'screen.family_tree.label_password_acc': 'Mật khẩu mặc định',
      'screen.family_tree.btn_confirm_create': 'TẠO & CHỌN NGAY',
      'screen.family_tree.create_acc_success': 'Đã tạo tài khoản thành công cho {name}.',

      // AddMemberScreen
      'screen.add_member.title': 'Thêm Thành Viên',
      'screen.add_member.title_edit': 'Chỉnh Sửa Thành Viên',
      'screen.add_member.btn_submit': 'GỬI YÊU CẦU THÊM',
      'screen.add_member.btn_admin_submit': 'THÊM THÀNH VIÊN',
      'screen.add_member.btn_admin_update': 'CẬP NHẬT THÀNH VIÊN',
      'screen.add_member.btn_member_request_update': 'GỬI YÊU CẦU CẬP NHẬT',
      'screen.add_member.placeholder_input': '...',
      ...
      'screen.add_member.msg_admin_success': 'Đã thêm thành viên trực tiếp vào gia phả.',
      'screen.add_member.msg_member_success': 'Yêu cầu đã được gửi. Vui lòng đợi quản trị viên phê duyệt.',

      // ── ApprovalScreen ───────────────────────────────────────────
      'screen.approval.title': 'PHÊ DUYỆT THÀNH VIÊN',
      'screen.approval.empty': 'Tất cả đã được xử lý',
      'screen.approval.date_new': 'Mới',
      'screen.approval.label_dharma_name': 'Pháp danh:',
      'screen.approval.label_gender': 'Giới tính:',
      'screen.approval.label_position': 'Vị trí:',
      'screen.approval.label_role_dept': 'Chức vụ/Ngành:',
      'screen.approval.label_req_type': 'Loại yêu cầu:',
      'screen.approval.type_update': 'Cập nhật gia phả',
      'screen.approval.type_new': 'Thêm mới hồ sơ',
      'screen.approval.btn_reject': 'Từ chối',
      'screen.approval.btn_approve': 'Phê duyệt',
      'screen.approval.footer': 'Quản trị hệ thống Vĩnh An',
      'screen.approval.modal_approve_title': 'Phê duyệt hồ sơ',
      'screen.approval.modal_reject_title': 'Từ chối yêu cầu',
      'screen.approval.modal_approve_msg': 'Bạn có chắc chắn muốn phê duyệt hồ sơ của {name}?',
      'screen.approval.modal_reject_msg': 'Bạn có chắc chắn muốn từ chối hồ sơ của {name}? Tất cả dữ liệu của yêu cầu này sẽ bị xóa.',
      'screen.approval.toast_approve_success': 'Đã phê duyệt tài khoản thành công!',
      'screen.approval.toast_approve_error': 'Không thể phê duyệt yêu cầu.',
      'screen.approval.toast_reject_success': 'Đã từ chối yêu cầu.',
      'screen.approval.toast_reject_error': 'Lỗi khi từ chối yêu cầu.',
